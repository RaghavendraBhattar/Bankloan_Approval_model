...
class ApprovalForm(forms.Form):
    ...
    married=forms.ChoiceField(choices=[('Yes', 'Yes'),
		('No', 'No')])
    graduatededucation=forms.ChoiceField(choices=[('Graduate', 'Graduated'),
		('Not_Graduate', 'Not_Graduate')])
    selfemployed=forms.ChoiceField(choices=[('Yes', 'Yes'),
		('No', 'No')])
    area=forms.ChoiceField(choices=[('Rural', 'Rural'),
		('Semiurban', 'Semiurban'),
		('Urban', 'Urban')])
